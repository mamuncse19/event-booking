...
<body data-spy="scroll" data-target="#site-nav">
    ...
    <script src="{{asset(config('app.asset').'frontend/bower_components/bootstrap/dist/js/bootstrap.min.js')}}"></script>
    <script src="{{asset(config('app.asset').'frontend/bower_components/smooth-scroll/dist/js/smooth-scroll.min.js')}}"></script>
